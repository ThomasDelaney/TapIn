package com.example.raulalvarez.thehub;
...
public class ClockIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.example.raulalvarez.thehub.BackgroundTask backgroundTask = new com.example.raulalvarez.thehub.BackgroundTask(new com.example.raulalvarez.thehub.BackgroundTask.AsyncResponse()
        {
            @Override
